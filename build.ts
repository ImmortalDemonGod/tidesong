...
<style>
  ...
  canvas{max-width:min(96vw,1240px);max-height:86vh;aspect-ratio:16/9;border-radius:10px;box-shadow:0 16px 70px rgba(0,0,0,.6),0 0 0 1px rgba(53,200,214,.18)}
